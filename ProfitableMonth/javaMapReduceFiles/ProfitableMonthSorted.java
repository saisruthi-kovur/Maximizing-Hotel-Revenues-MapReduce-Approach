...
public class ProfitableMonthSorted {
    // Mapper class
    ...
    public static class BookingReducer extends Reducer<Text, FloatWritable, Text, FloatWritable> {
        ...
        public void reduce(Text key, Iterable<FloatWritable> values, Context context)
            ...
            // Add revenue and month to the TreeMap for sorting
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            ...
            for (Map.Entry<Float, Text> entry : revenueMap.entrySet()) {
                ...
                Text monthYear = entry.getValue();
                context.write(monthYear, new FloatWritable(revenue));
            }
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(ProfitableMonthSorted.class);
